...
public class GiftDeedPDFEXT {
	...
	String filename = "/Users/kayode/Desktop/PDF_TRIAL/DOG";
	String date = "02/07/1987 00:00 AM";
	String donorName = "Olugbenga Oluyemi Akinnuga";
	String donorAddress = "10, Ibidun Street, Lekki Phase 1";

	String doneeName = "Toyosi Omobolanle Akinnuga";
	String doneeAddress = "10, Ibidun Street, Lekki Phase 1";

	String relationshipToDonor = "Daughter";
	String relationshipToDonee = "Father";

	String amount = "N10,000000";
	String donorBankName = "Access Bank PLC";
	String donorAccountNumber = "1198820018";
	String donorAccountName = "Olugbenga Oluyemi Akinnuga";
	
	String doneeBankName = "Stanbic IBTC Bank PLC";
	String doneeAccountNumber = "0099110021";
	String doneeAccountName = "Toyosi Omobolanle Akinnuga";
	
	String mode="Cash Deposit";
	String donorWitnessName ="Bolaji Bashorun";
	
	String donorWitnessAddress="Osapa, Lekki Lagos";
	String donorWitnessOccupation="Business Development Manager";
	
	String doneeWitnessName="Biyi Ladapo";
	String doneeWitnessAddress="Ikate, Lekki Lagos";
	String doneeWitnessOccupation="Lawyer";
	String notaryName="Oluseun O. Fadele";
	...
	public GiftDeedPDFEXT() throws IOException, ParseException {

		getPDFDocument(date, filename, donorName, donorAddress, doneeName, doneeAddress, relationshipToDonor,
				relationshipToDonee, amount, donorBankName, donorAccountNumber, donorAccountName, mode, doneeBankName, doneeAccountNumber, doneeAccountName,
				 donorWitnessName,  donorWitnessAddress,  donorWitnessOccupation,  doneeWitnessName,  doneeWitnessAddress,  doneeWitnessOccupation, notaryName);
	}

	public void getPDFDocument(String date, String filename, String donorName, String donorAddress, String doneeName,
			String doneeAddress, String relationshipToDonor, String relationshipToDonee, String amount,
			String donorBankName, String donorAccountNumber, String donorAccountName, String mode, String doneeBankName, String doneeAccountNumber, String doneeAccountName,
			String donorWitnessName, String donorWitnessAddress, String donorWitnessOccupation, String doneeWitnessName, String doneeWitnessAddress, String doneeWitnessOccupation, String notaryName )
		...
		Text dName = new Text(donorName.toUpperCase());
		dName.setFontSize(12);
		dName.setFont(bold);
		//dName.setUnderline(1, -1);
		
		Text dAdd = new Text(donorAddress);
		dAdd.setFontSize(textFontSize);
		dAdd.setFont(bold);
		//dAdd.setUnderline(1, -1);
		
		Text dnName = new Text(doneeName.toUpperCase());
		dnName.setFontSize(12);
		dnName.setFont(bold);
		//dnName.setUnderline(1, -1);
		
		Text dnAdd = new Text(doneeAddress);
		...
		Text t2 = new Text(relationshipToDonee);
		//t2.setUnderline(1, -1);
		t2.setFont(bold);
		...
		Text t4 = new Text(relationshipToDonor);
		//t4.setUnderline(1, -1);
		t4.setFont(bold);
		...
		Text t5 = new Text(amount);
		//t5.setUnderline(1, -1);
		t5.setFont(bold);
		t5.setFontSize(textFontSize);
		
		Text t6 = new Text(donorBankName);
		//t6.setUnderline(1, -1);
		t6.setFont(bold);
		t6.setFontSize(textFontSize);
		
		Text t7 = new Text(donorAccountNumber);
		//t7.setUnderline(1, -1);
		t7.setFont(bold);
		t7.setFontSize(textFontSize);
		
		Text t8 = new Text(donorAccountName);
		//t8.setUnderline(1, -1);
		t8.setFont(bold1);
		t8.setFontSize(textFontSize);

		Paragraph p3 = new Paragraph();
		p3.add("The DONOR is the rightful owner of the sum of ").add(t5).add("  domiciled in the DONOR's bank account with ")
		.add(t6).add(" with account number ").add(t7).add(" and account name ").add(t8).add(" (hereinafter referred to as Donor’s Bank Account)");
		...
		Text t10 = new Text(mode);
		t10.setFont(bold1);
		t10.setFontSize(textFontSize);
		
		Text t11 = new Text(doneeBankName);
		t11.setFont(bold1);
		t11.setFontSize(textFontSize);
		
		Text t12 = new Text(doneeAccountNumber);
		t12.setFont(bold1);
		t12.setFontSize(textFontSize);
		
		Text t13 = new Text(doneeAccountName);
		t13.setFont(bold1);
		t13.setFontSize(textFontSize);
		
		String dateTrans = dateFormat.getCurrentDateInSpecificFormatDate2(date);
		...
		p5.add(longText2).add(t5).add(" transferred via ").add(t10).add(" on the ").add(DT).add(" from DONOR’s BANK ACCOUNT to the DONEE’s BANK ACCOUNT domiciled with ")
		.add(t11).add(" having the Account Number: ").add(t12).add(" and the Account Name ").add(t13).add(" (the receipt of which the DONEE hereby acknowledges)");
		...
		img1.getAccessibilityProperties().setAlternateDescription("notariza_signature");
		pSig.add(img1);
		...
		img2.getAccessibilityProperties().setAlternateDescription("notariza_signature");
		pStamp1.add(img2);
		...
		img3.getAccessibilityProperties().setAlternateDescription("notariza_signature");
		...
		Text wName = new Text(donorWitnessName);
		wName.setFont(bold1);
		wName.setFontSize(textFontSize);
		
		Text wAddress = new Text(donorWitnessAddress);
		wAddress.setFont(bold1);
		wAddress.setFontSize(textFontSize);
		
		Text wOccupation = new Text(donorWitnessOccupation);
		...
		Text wName2 = new Text(doneeWitnessName);
		wName2.setFont(bold1);
		wName2.setFontSize(textFontSize);
		
		Text wAddress2 = new Text(doneeWitnessAddress);
		wAddress2.setFont(bold1);
		wAddress2.setFontSize(textFontSize);
		
		Text wOccupation2 = new Text(doneeWitnessOccupation);
